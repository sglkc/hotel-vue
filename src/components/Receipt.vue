<template>
  <v-container id="receipt">
    <v-row class="pt-2 mb-4">
    ...
    <v-row class="mt-3">
      ...
      <v-col>
        <v-img
          class="mb-3"
          height="100"
          src="http://cdn.onlinewebfonts.com/svg/img_481313.png"
          eager
        ></v-img>
      </v-col>
    </v-row>
      ...
      <v-col class="pa-0">
        <v-container>
          ...
          <v-row class="table-row mt-3">
            ...
            <v-col class="py-1 text-end" cols="2">
          ...
          <v-row class="table-row mt-3">
            ...
            <v-col class="py-1 text-end" cols="2">Rp.0</v-col>
          </v-row>
          <v-row class="table-row mt-3">
            <v-col class="py-1" cols="8"></v-col>
    ...
    <v-row class="mt-10 font-italic text-caption">
